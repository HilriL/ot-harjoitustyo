...
class TestMaksukortti(unittest.TestCase):
    ...
    def testi_syo_edullisesti_vahentaa_saldoa_oikein(self):
    ...
    def test_voi_ostaa_edullisen_lounaan_kun_saldoa_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_voi_ostaa_maukkaan_lounaan_kun_saldoa_lounaan_verran(self):
